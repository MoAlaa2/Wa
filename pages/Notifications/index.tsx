    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">{t.notifications.desc}</p>
        </div>
        <button 
        ...
        <div className="flex gap-2">
           <select 
            ...
            >
             ...
             <option value="RUNNING">{t.notifications.status.RUNNING}</option>
             <option value="PAUSED">{t.notifications.status.PAUSED}</option>
             <option value="COMPLETED">{t.notifications.status.COMPLETED}</option>
           </select>
        </div>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider">{t.notifications.table.title}</th>
                  <th className="px-6 py-3 text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider">{t.notifications.table.status}</th>
                  <th className="px-6 py-3 text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-1/4">{t.notifications.table.progress}</th>
                  <th className="px-6 py-3 text-left rtl:text-right text-xs font-medium text-gray-500 uppercase tracking-wider">{t.notifications.table.created}</th>
