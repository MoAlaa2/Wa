    ...
    <div className="space-y-8 animate-fadeIn pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">High-level overview. Click cards for details.</p>
        </div>
      </div>
             ...
             <div className="md:col-span-2 bg-white rounded-xl border border-gray-200 p-6">
               ...
               <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg border border-green-100">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-green-600">WhatsApp API Connected • Webhooks Active</div>
                  </div>
               </div>
             </div>
             
             <div className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col justify-center items-center text-center">
                <h3 className="font-bold text-gray-900 mb-2">Need a Report?</h3>
                <p className="text-sm text-gray-500 mb-4">Export detailed CSV reports for your team.</p>
                <button 
