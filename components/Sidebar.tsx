...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const [isAnalyticsOpen, setAnalyticsOpen] = useState(true); // Default open
  ...
  const showAnalytics = hasPermission('view_analytics') || hasPermission('view_dashboard'); // Using dashboard perm as fallback
